    ...
    <?php endif; ?>
      <div class = "box">
            ...
            <div class="col card-hader text-right">
                <a href="<?=site_url('provinsi/tambah')?>" class="btn btn-primary btn-flat">
...
<tr>
        ...
        <form action="<?=site_url('provinsi/del')?>" method="post">    
        <a href="<?=site_url('provinsi/ed/'.$data->id_prov)?>" class="btn btn-primary btn-xs">
                   <i class="fa fa-pencil"></i>  Edit
            </a>
            
            <input type="hidden" name="id_prov" value="<?=$data->id_prov?>">
