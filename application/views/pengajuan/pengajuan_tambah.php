    ...
    <div class="row">
        <div class="col-md-12 md-offset-4">
            <div class="box">
                ...
                <form action="<?= base_url('pengajuan/input') ?>" method="post">
                    <table>
                        <tr>
                            <td>Perihal</td>
                            <td>:</td>
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                <select name="spv" class="form-control" required>
                                    <option value="10" <?= set_value('spv') == 10 ? "selected" : null ?>>Testingku</option>
                                    <option value="13" <?= set_value('spv') == 13 ? "selected" : null ?>>spv2</option>
                                </select>
