    ...
    <div class="box">
        <div class="box-header">
            ...
            <div class="col card-header text-right">
                <a href="<?= site_url('pengajuan/tambah_spv') ?>" class="btn btn-primary btn-flat">
        ...
        <div class="box-body table-responsive">
            <table class="table table-bordered table-striped" id="example">
                ...
                <tbody>
                    <?php $no = 1; foreach ($aju_spv as $data): ?>
                    <tr>
                        ...
                        <td class="text-center" width="160px">
                            <?php if ($data->status == 2): ?>
                                <a href="<?= site_url('pengajuan/kr_spv/' . $data->id_aju) ?>" class="btn btn-primary btn-xs">
                                    <i class="fa fa-send"></i> Kirim
                                </a>
                                <a href="<?= site_url('pengajuan/del_spv/' . $data->id_aju) ?>" 
