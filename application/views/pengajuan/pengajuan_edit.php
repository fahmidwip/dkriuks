    ...
    <div class="row">
        <div class="col-md-12 md-offset-4">
            <div class="box">
                ...
                <form action="<?= base_url('pengajuan/editin') ?>" method="post">
                    <table>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="spv" class="form-control" required>
                                    <option value="10" <?= $ajuan->spv == 10 ? "selected" : null ?>>Testingku</option>
                                    <option value="13" <?= $ajuan->spv == 13 ? "selected" : null ?>>Spv2</option>
                                </select>
