  ...
  <?php if (!empty($keranjang) && is_array($keranjang)): ?>
      <div class="box">
        ...
        <center><img src="<?=base_url()?>assets/dist/img/ddk.png" alt="User Image" width="140" height="70" class="gambar"></center><br>
          <h5><center>Kode Pesanan: <strong><?= $keranjang[0]->kode_pesanan ?></strong></center></h5>
          <h5><center>Tanggal Pesanan: <strong><?= tgl_indo($keranjang[0]->created_at) ?></strong></center></h5>
